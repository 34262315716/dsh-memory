...
var GRAPH_VIEW_FIELDS = [
  ...
  ["depthAngle", "\u7EB5\u6DF1\u89D2\u5EA6\xB0", "\u62D6\u5C3E\u65B9\u5411\u89D2\uFF08-180~180\uFF0C\u9ED8\u8BA4 20\uFF1B\u6B63=\u5411\u53F3\u4E0A\u7EB5\u6DF1\uFF0C\u8D8A\u8FDC\u8D8A\u5F80\u4E0A\uFF09"],
...
var NUMERIC_SUB = /* @__PURE__ */ new Set(["cacheSize", "topK", "minCandidates", "rrfWeight", "spring", "repulsion", "damping", "gravity", "depthAngle", "trailSegments", "trailGap", "trailShrink", "trailFade", "interval", "maxIntervalHours", "dedupThreshold", "agingDays"]);
...
var ObsidianGraph = (0, import_react2.memo)(function ObsidianGraph2({ data, onSelect, selectedRef, drawRef, physics, focusIdsRef, depth }) {
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const tDirX = Math.cos(tRad), tDirY = -Math.sin(tRad);
    const heat = (a) => {
    ...
    const fitToView = () => {
      ...
      if (trailSegs > 0) {
        ...
        minX += Math.min(0, tDirX) * ext;
        maxX += Math.max(0, tDirX) * ext;
        minY += Math.min(0, tDirY) * ext;
        maxY += Math.max(0, tDirY) * ext;
      }
...
function MemoryGraphView({ scope }) {
  ...
  const depth = (0, import_react2.useMemo)(() => ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", height: "100%", minHeight: 560, gap: 0 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { flex: 1, minWidth: 0, position: "relative", minHeight: 560 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ObsidianGraph, { data: filtered, onSelect: setSelected, selectedRef, drawRef, physics, depth, focusIdsRef }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { position: "absolute", right: 14, bottom: 10, fontSize: 11, color: "#777", zIndex: 2 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: "#5b9bd5" }, children: "\u2014 similarTo \u8BED\u4E49\u76F8\u4F3C" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { marginLeft: 10, color: "#e07b39" }, children: "\u2192 before \u65F6\u95F4\u6F14\u5316" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { marginLeft: 10, color: "#ffd54f" }, children: "\u25CE \u5916\u73AF = \u66F4\u65B0\u8FC7\uFF08\u73AF\u6570 = \u66F4\u65B0\u6B21\u6570\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { marginLeft: 10 }, children: "\u8272\u6D45\u65B0 \xB7 \u8272\u6DF1\u65E7" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { marginLeft: 10 }, children: "\u62D6\u8282\u70B9 \xB7 \u5E73\u79FB \xB7 \u7F29\u653E \xB7 \u70B9\u51FB\u770B\u8BE6\u60C5" })
      ] })
    ] }),

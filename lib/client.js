...
var ObsidianGraph = (0, import_react2.memo)(function ObsidianGraph2({ data, onSelect, selectedRef, drawRef, physics, focusIdsRef }) {
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const nodes = data.nodes.map((n) => {
      ...
      return { ...n, x: p[0], y: p[1], vx: 0, vy: 0, degree: degree.get(n.id) ?? 0, color: ageShade(colorOf(n.theme), n.createdAt, minCreated, now), ph: Math.random() * Math.PI * 2, fq: 0.22 + Math.random() * 0.3 };
    });
    ...
    const tSec = () => performance.now() / 1e3;
      ...
      for (const n of nodes) {
        ...
        if (n.versions > 1) {
          ...
          for (let ri = 0; ri < rings; ri++) {
            ctx.beginPath();
            ctx.arc(sx(n), sy(n), r + 3 + ri * step2, 0, Math.PI * 2);
...
var DetailPanel = (0, import_react2.memo)(function DetailPanel2({ selected, data }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { width: 280, borderLeft: "1px solid #333", padding: 14, overflowY: "auto", background: "#161616" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h4", { style: { margin: "0 0 8px", color: colorOf(selected.theme) }, children: selected.theme || "(\u672A\u5F52\u7C7B)" }),
...
function MemoryGraphView({ scope }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", height: "100%", minHeight: 560, gap: 0 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { flex: 1, minWidth: 0, position: "relative", minHeight: 560 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { position: "absolute", right: 14, bottom: 10, fontSize: 11, color: "#777", zIndex: 2, display: "flex", flexWrap: "wrap", gap: 8, maxWidth: "72%", justifyContent: "flex-end" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u8272\u6D45\u65B0 \xB7 \u8272\u6DF1\u65E7" }),

...
var NUMERIC_SUB = /* @__PURE__ */ new Set(["cacheSize", "topK", "minCandidates", "rrfWeight", "spring", "repulsion", "damping", "gravity", "interval", "maxIntervalHours", "dedupThreshold", "agingDays", "gapHours", "maxRows", "maxTokens"]);
  ...
  render() {
    if (this.state.error) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 16 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: "#e67e22", fontWeight: 500, fontSize: 13 }, children: "\u26A0 \u8BBE\u7F6E\u9762\u677F\u6E32\u67D3\u51FA\u9519" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { style: { whiteSpace: "pre-wrap", fontSize: 12, color: "#e66", background: "#1e1e1e", padding: 8, borderRadius: 6, margin: "8px 0" }, children: String(this.state.error?.message ?? this.state.error) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
...
function MemorySettingsSectionInner({ scope, api, llmScope, deepseekScope }) {
  ...
  const TEXT_TOP = /* @__PURE__ */ new Set(["dbFile", "scope"]);
  ...
  const save = async () => {
    ...
    try {
      ...
      if (gvKeys.some((f) => drafts[`graphView.${f}`] !== void 0) || drafts["graphView.themeShape"] !== void 0 || drafts["graphView.themeScope"] !== void 0 || drafts["graphView.layoutQuality"] !== void 0) {
        ...
        if (drafts["graphView.layoutQuality"] !== void 0) next.layoutQuality = String(drafts["graphView.layoutQuality"]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 16, maxWidth: 680, boxSizing: "border-box" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: "#888", fontSize: 12, margin: "0 0 10px 0" }, children: "v0.10 \u6CE8\u5165\u52A0\u6743\uFF1A\u753B\u50CF \xD73 \xB7 principle\uFF08\u65B9\u6CD5/\u539F\u5219\uFF09\xD71.5 \u4F18\u5148 \xB7 event\uFF08\u4E8B\u4EF6/\u4EA7\u51FA\uFF09\xD70.7 \u964D\u6743\uFF08\u5F3A\u76F8\u5173\u624D\u6CE8\u5165\uFF09\uFF1B \u84B8\u998F\u8F93\u51FA\u81EA\u52A8\u6253 theme \u540D\u8BCD\u6807\u7B7E\uFF08\u4EC5\u65B0\u8BB0\u5FC6\uFF09\u3002" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u63A8\u7406\u6863\u4F4D\uFF08reasoningEffort\uFF09", hint: "off=\u5173\u601D\u7EF4\u94FE\u76F4\u51FA JSON\uFF08\u9ED8\u8BA4\uFF1B\u63A8\u7406\u6863\u4F1A\u628A maxTokens \u5403\u5149\u5BFC\u81F4\u84B8\u998F 100% \u5931\u8D25\u2014\u2014v0.9.25 \u6559\u8BAD\uFF09\uFF1B\u4EC5\u9002\u914D\u5668\u58F0\u660E supportsReasoningEffort \u65F6\u900F\u4F20", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u8F93\u51FA\u4E0A\u9650\uFF08maxTokens\uFF09", hint: "\u84B8\u998F JSON \u957F\u5EA6\u9884\u7B97\uFF08100~4000\uFF0C\u9ED8\u8BA4 1200\uFF09\uFF1B\u5173\u95ED\u63A8\u7406\u540E\u4ECD\u504F\u7D27\u53EF\u4E0A\u8C03", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      embChanging && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 10, padding: 10, border: "1px solid #b76e2b", borderRadius: 8, background: "#2a2118" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, fontWeight: 600, color: "#e8a24a" }, children: "\u26A0 \u5207\u6362\u5D4C\u5165\u6A21\u578B\u4F1A\u89E6\u53D1\u5411\u91CF\u5E93\u91CD\u5EFA" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { color: "#c9a27a", fontSize: 12, margin: "6px 0" }, children: [
          "\u5D4C\u5165\u4F9B\u5E94\u5546/\u6A21\u578B\u7684\u6539\u52A8",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u5E03\u5C40\u8D28\u91CF", hint: "\u7CBE\u786E=\u4E00\u76F4\u7B97\u5230\u6240\u6709\u70B9\u90FD\u4E0D\u52A8\u518D\u5C55\u793A\uFF08\u9ED8\u8BA4\uFF0C\u9884\u7B97 4s\uFF09| \u5747\u8861=\u9650\u65F6 1.2s \u51FA\u56FE | \u6781\u901F=\u4E0D\u91CD\u7B97\uFF0C\u76F4\u63A5\u7528\u4E0A\u6B21\u7F13\u5B58/\u521D\u59CB\u5E03\u5C40\u3002\u8282\u70B9\u6570\u8D85 900/1800 \u4F1A\u81EA\u52A8\u964D\u6863", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "select",
        {
          style: inputStyle,
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "precise", children: "\u7CBE\u786E\uFF08\u7B97\u5230\u9759\u6B62\u518D\u5C55\u793A\uFF09" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "balanced", children: "\u5747\u8861\uFF08\u9650\u65F6 1.2s\uFF09" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "instant", children: "\u6781\u901F\uFF08\u4E0D\u91CD\u7B97\uFF09" })
          ]
        }
      ) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 4px", color: "#888", fontSize: 12 }, children: '\u65F6\u95F4\u8FDE\u7EED + \u56E0\u679C\u76F8\u5173\u7684\u8BB0\u5FC6\u805A\u7C07\u2014\u2014"\u8FD9\u6BB5\u8BB0\u5FC6\u5C5E\u4E8E\u54EA\u4EF6\u4E8B"\uFF08\u533A\u522B\u4E8E theme \u7684"\u5728\u8BB2\u4EC0\u4E48"\uFF09\uFF1B\u7EAF rule \u65F6\u95F4\u7EBF\u626B\u63CF\uFF0C\u7BA1\u5BB6/\u542F\u52A8\u81EA\u52A8\u7EF4\u62A4\u3002' }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        CheckboxRow,
        {
          label: "\u542F\u7528\u4E8B\u4EF6\u5206\u7C7B",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 4px", color: "#888", fontSize: 12 }, children: "\u80CC\u540E\u8FD0\u884C\u4E86\u4EC0\u4E48\u5B8C\u5168\u900F\u660E\u53EF\u89C1\uFF1A\u5199\u5165/\u6CE8\u5165/\u68C0\u7D22/\u5DE1\u68C0/\u84B8\u998F/\u9519\u8BEF\u5168\u94FE\u8DEF\u57CB\u70B9\uFF1BGUI\u300C\u8BB0\u5FC6\u65E5\u5FD7\u300D\u9762\u677F + memory_logs \u5DE5\u5177\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        CheckboxRow,
        {
          label: "\u542F\u7528\u8FD0\u884C\u65E5\u5FD7",
...
function convexHull(points) {
  ...
  pts.sort((a2, b) => a2[0] - b[0] || a2[1] - b[1]);
  const uniq = [];
  for (const p of pts) {
  ...
  const cross = (o, a2, b) => (a2[0] - o[0]) * (b[1] - o[1]) - (a2[1] - o[1]) * (b[0] - o[0]);
  const lower = [];
  for (const p of uniq) {
...
function padConvexPolygon(poly, pad) {
  ...
  for (let i = 0; i < n; i++) {
    ...
    const nx = dy / len;
    const ny = -dx / len;
    lines.push({ px: a2.x + nx * width, py: a2.y + ny * width, dx, dy });
  }
  const out = [];
...
function polygonContains(poly, p, eps = 1e-6) {
  ...
  if (n === 2) {
    const [a2, b] = poly;
    const l2 = (b.x - a2.x) ** 2 + (b.y - a2.y) ** 2;
    if (l2 === 0) return Math.hypot(p.x - a2.x, p.y - a2.y) <= eps;
    let t = ((p.x - a2.x) * (b.x - a2.x) + (p.y - a2.y) * (b.y - a2.y)) / l2;
    t = Math.max(0, Math.min(1, t));
    return Math.hypot(p.x - (a2.x + t * (b.x - a2.x)), p.y - (a2.y + t * (b.y - a2.y))) <= eps;
  }
  for (let i = 0; i < n; i++) {
    const a2 = poly[i];
    const b = poly[(i + 1) % n];
    const cr = (b.x - a2.x) * (p.y - a2.y) - (b.y - a2.y) * (p.x - a2.x);
    if (cr < -eps) return false;
  }
  return true;
}
function circleFrom2(a2, b) {
  const cx = (a2.x + b.x) / 2;
  const cy = (a2.y + b.y) / 2;
  return { x: cx, y: cy, r: Math.hypot(a2.x - b.x, a2.y - b.y) / 2 };
}
function circleFrom3(a2, b, c) {
  const d = 2 * (a2.x * (b.y - c.y) + b.x * (c.y - a2.y) + c.x * (a2.y - b.y));
  if (Math.abs(d) < 1e-12) {
    let best = null;
    for (const [p, q] of [[a2, b], [b, c], [a2, c]]) {
      const t = circleFrom2(p, q);
      if (!best || t.r > best.r) best = t;
    }
    return best;
  }
  const a22 = a2.x * a2.x + a2.y * a2.y;
  const b2 = b.x * b.x + b.y * b.y;
  const c2 = c.x * c.x + c.y * c.y;
  const ux = (a22 * (b.y - c.y) + b2 * (c.y - a2.y) + c2 * (a2.y - b.y)) / d;
  const uy = (a22 * (c.x - b.x) + b2 * (a2.x - c.x) + c2 * (b.x - a2.x)) / d;
  return { x: ux, y: uy, r: Math.hypot(ux - a2.x, uy - a2.y) };
}
...
function clusterByDistance(points, threshold, { minSize = 1 } = {}) {
  ...
  const order = pts.map((p, i) => i).sort((a2, b) => pts[a2].x - pts[b].x);
  const d2 = d * d;
  for (let i = 0; i < order.length; i++) {
    const a2 = pts[order[i]];
...
// client/layout-policy.js
var STOP_SPEED = 0.02;
var AUTO_DOWNGRADE = { balanced: 2e3, instant: 6e3 };
function resolveLayoutPlan({ quality = "precise", nodeCount = 0, hasCache = false } = {}) {
  ...
  return {
    mode,
    compute: true,
    budgetMs: precise ? 4e3 : 1200,
    stepCap: precise ? 8e3 : 3e3,
    stopSpeed: STOP_SPEED,
    downgraded,
    reason
  };
}
function progressLabel(plan, step, maxSpeed) {
...
var ObsidianGraph = (0, import_react2.memo)(function ObsidianGraph2({ data, onSelect, selectedRef, drawRef, physics, focusIdsRef, themeFocusRef }) {
  const canvasRef = (0, import_react2.useRef)(null);
  const [progress, setProgress] = (0, import_react2.useState)(null);
  const hoverRef = (0, import_react2.useRef)(null);
  const hoverEdgeRef = (0, import_react2.useRef)(null);
  (0, import_react2.useEffect)(() => {
    ...
    if (cacheMap) {
      ...
      for (const n of data.nodes) {
        ...
        const a2 = acc.get(n.theme) ?? { x: 0, y: 0, n: 0 };
        a2.x += p[0];
        a2.y += p[1];
        a2.n++;
        acc.set(n.theme, a2);
      }
      for (const [t, a2] of acc) if (a2.n > 0) themeCentroid.set(t, [a2.x / a2.n, a2.y / a2.n]);
    }
    const now = Date.now();
    ...
    const REP_BOOST = 2;
    const REP_FAR = 1.2;
    const repGrid = /* @__PURE__ */ new Map();
    const COLLIDE_GAP = 6;
    ...
    for (const n of nodes) {
      ...
      const a2 = themeAnchor.get(n.theme) ?? { x: 0, y: 0, n: 0 };
      a2.x += n.x;
      a2.y += n.y;
      a2.n++;
      themeAnchor.set(n.theme, a2);
    }
    for (const [t, a2] of themeAnchor) themeAnchor.set(t, { x: a2.x / a2.n, y: a2.y / a2.n });
    const hash01 = (id) => {
      let h = 2166136261;
      const s2 = String(id);
    ...
    const step = (fixedAlpha) => {
      ...
      if (dragNode) alpha = Math.max(alpha, 0.15);
      {
        ...
        for (const a2 of nodes) {
          const gxa2 = Math.floor(a2.x / R);
          const gya2 = Math.floor(a2.y / R);
          for (let ix = gxa2 - 1; ix <= gxa2 + 1; ix++) {
            for (let iy = gya2 - 1; iy <= gya2 + 1; iy++) {
              const arr = repGrid.get(ix * 100003 + iy);
              if (!arr) continue;
              for (const b of arr) {
                if (b.id <= a2.id) continue;
                let dx = a2.x - b.x, dy = a2.y - b.y;
                let d2 = dx * dx + dy * dy;
                if (d2 < 1e-6) {
                  dx = Math.random() - 0.5;
                  dy = Math.random() - 0.5;
    ...
    const draw = () => {
      ...
      if (!plan) {
        ...
        plan.sort((a2, b) => b.members.length - a2.members.length);
      ...
      for (let i = 0; i < plan.length; i++) {
        ...
        if (raw.kind === "hull") {
          ...
          drawShape = { kind: "hull", points: pts, cx: pts.reduce((a2, p) => a2 + p.x, 0) / pts.length, topY: Math.min(...pts.map((p) => p.y)) };
        } else {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { position: "relative", width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("canvas", { ref: canvasRef, style: { width: "100%", height: "100%", display: "block", cursor: "grab" } }),
    progress ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, background: "rgba(18,18,22,0.75)", color: "#ddd", zIndex: 5 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: 13 }, children: progress.text }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { width: 260, height: 6, borderRadius: 3, background: "#333", overflow: "hidden" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { width: progress.pct + "%", height: "100%", background: "#5b9bd5", transition: "width .12s linear" } }) }),
      progress.note ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: 11, color: "#888" }, children: progress.note }) : null
    ] }) : null
  ] });
});
var DetailPanel = (0, import_react2.memo)(function DetailPanel2({ selected, data }) {
  const { colorOf, adj, nodeById } = (0, import_react2.useMemo)(() => {
    ...
    for (const e of data.edges) {
      if (!a2.has(e.from)) a2.set(e.from, []);
      a2.get(e.from).push({ other: e.to, type: e.type, weight: e.weight });
      if (!a2.has(e.to)) a2.set(e.to, []);
      a2.get(e.to).push({ other: e.from, type: e.type, weight: e.weight });
    }
    return { colorOf: co, adj: a2, nodeById: nodeById2 };
  }, [data]);
  if (!selected) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { width: 280, borderLeft: "1px solid #333", padding: 14, overflowY: "auto", background: "#161616" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h4", { style: { margin: "0 0 8px", color: colorOf(selected.theme, selected.type) }, children: selected.theme || "(\u672A\u5F52\u7C7B)" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { style: { fontSize: 12, color: "#888", margin: "0 0 10px" }, children: [
      selected.type,
      " \xB7 ",
      selected.layer,
      " \xB7 strength ",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { style: { fontSize: 12, margin: "0 0 10px" }, children: [
      (selected.versions ?? 1) > 1 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { color: "#ffd54f" }, children: [
        "\u25C9 \u66F4\u65B0\u8FC7 ",
        (selected.versions ?? 1) - 1,
        " \u6B21\uFF08\u4E16\u754C\u7EBF\u4FDD\u7559\u6700\u8FD1 ",
        selected.versions ?? 1,
        " \u6BB5\uFF09"
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: "#777" }, children: "\u25CB \u672A\u66F4\u65B0\u8FC7\uFF08\u5355\u7248\u672C\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { color: "#888" }, children: [
        " \xB7 \u521B\u5EFA\u4E8E ",
        agoText(selected.createdAt)
      ] }),
      selected.updatedAt && selected.updatedAt !== selected.createdAt ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { color: "#888" }, children: [
        " \xB7 \u6700\u540E\u66F4\u65B0 ",
        agoText(selected.updatedAt)
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: { fontSize: 13, lineHeight: 1.6, whiteSpace: "pre-wrap" }, children: selected.content }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h5", { style: { margin: "14px 0 6px", fontSize: 12, color: "#aaa" }, children: "\u5173\u8054\u8BB0\u5FC6" }),
    (adj.get(selected.id) ?? []).length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: { fontSize: 12, color: "#777" }, children: "\u6682\u65E0\u5173\u8054" }) : (adj.get(selected.id) ?? []).map((a2, i) => {
      const other = nodeById.get(a2.other);
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontSize: 12, margin: "4px 0", color: "#bbb" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { color: a2.type === "similarTo" ? "#5b9bd5" : "#e07b39" }, children: [
          "[",
          a2.type,
          "]"
        ] }),
        a2.type === "similarTo" ? " \u76F8\u4F3C " + a2.weight.toFixed(2) + " " : " ",
        other ? other.label.slice(0, 12) : a2.other
      ] }, i);
    })
  ] });
});
function MemoryGraphView({ scope }) {
  ...
  const drawRef = (0, import_react2.useRef)(null);
  const [gv, setGv] = (0, import_react2.useState)(() => {
    try {
  ...
  const physics = (0, import_react2.useMemo)(() => ({
    ...
    // 显示策略（v0.10.6）
    layoutQuality: gv.layoutQuality === "balanced" || gv.layoutQuality === "instant" ? gv.layoutQuality : "precise"
    // 布局质量（v0.10.13）
  ...
  (0, import_react2.useEffect)(load, [load]);
  (0, import_react2.useEffect)(() => {
    selectedRef.current = selected?.id ?? null;
    drawRef.current?.();
  }, [selected]);
  const [ageWindow, setAgeWindow] = (0, import_react2.useState)("all");
  ...
  const [eventFilter, setEventFilter] = (0, import_react2.useState)("all");
  const focusIdsRef = (0, import_react2.useRef)(null);
  (0, import_react2.useEffect)(() => {
  ...
  const [themeFilter, setThemeFilter] = (0, import_react2.useState)("all");
  const themeFocusRef = (0, import_react2.useRef)(null);
  const themeStampRef = (0, import_react2.useRef)(0);
  const themeCounts = (0, import_react2.useMemo)(() => {
    ...
    return [...m.entries()].sort((a2, b) => b[1] - a2[1] || a2[0].localeCompare(b[0]));
  }, [filtered]);
  (0, import_react2.useEffect)(() => {
    if (themeFilter === "all") {
  ...
  if (error) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { padding: 24 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { style: { margin: "0 0 12px" }, children: "\u8BB0\u5FC6\u56FE\u8C31" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { style: { color: "#e07b39" }, children: [
        "\u52A0\u8F7D\u5931\u8D25\uFF1A",
        error
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: load, style: { padding: "4px 16px", borderRadius: 6, border: "1px solid #555", background: "transparent", color: "#aaa", cursor: "pointer" }, children: "\u91CD\u8BD5" })
    ] });
  }
  if (!data) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { padding: 24, color: "#888" }, children: "\u52A0\u8F7D\u8BB0\u5FC6\u56FE\u8C31\u4E2D\u2026" });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", height: "100%", minHeight: 560, gap: 0 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { flex: 1, minWidth: 0, position: "relative", minHeight: 560 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { position: "absolute", top: 10, left: 14, fontSize: 12, color: "#aaa", zIndex: 2, display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "select",
          {
            ...
            children: AGE_WINDOWS.map(([v, label]) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: v, children: label }, v))
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "select",
          {
            ...
            children: [
              ...
              (data?.events ?? []).map((e) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("option", { value: e.id, children: [
                e.label,
                "\uFF08",
                e.count,
                " \u6761\uFF09"
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "all", children: "\u5168\u90E8\u4E3B\u9898" }),
              themeCounts.map(([t, c]) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("option", { value: t, children: [
                t,
                "\uFF08",
                c,
                " \u6761\uFF09"
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: load, style: { padding: "1px 10px", borderRadius: 5, border: "1px solid #555", background: "transparent", color: "#aaa", cursor: "pointer", fontSize: 12 }, children: "\u5237\u65B0" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ObsidianGraph, { data: filtered, onSelect: setSelected, selectedRef, drawRef, physics, focusIdsRef, themeFocusRef }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { position: "absolute", right: 14, bottom: 10, fontSize: 11, color: "#777", zIndex: 2, display: "flex", flexWrap: "wrap", gap: 8, maxWidth: "72%", justifyContent: "flex-end", alignItems: "center" }, children: [
        (filtered?.nodes ?? []).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u8282\u70B9\u8272\uFF1A" }),
          Object.entries(TYPE_COLORS).filter(([t2]) => (filtered?.nodes ?? []).some((n) => n.type === t2)).map(([t2, c]) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: 3 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("i", { style: { width: 8, height: 8, borderRadius: "50%", background: c, display: "inline-block" } }),
            TYPE_LABEL[t2] ?? t2
          ] }, t2)),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: "#888" }, children: "\u65E0\u4E3B\u9898\u9ED8\u8BA4\u6309\u7C7B\u578B\u4E0A\u8272" })
        ] }),
        EDGE_ORDER.filter((t2) => (filtered?.edges ?? []).some((e) => e.type === t2)).map((t2) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { color: EDGE_STYLE[t2].color }, children: [
          t2 === "similarTo" ? "\u2014" : t2 === "before" ? "\u2192" : t2 === "mentions" ? "\xB7 \xB7" : "\u2014",
          " ",
          EDGE_LABEL[t2]
        ] }, t2)),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: "#ffd54f" }, children: "\u25CE +N = \u66F4\u65B0\u8FC7 N \u6B21" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u8272\u6D45\u65B0 \xB7 \u8272\u6DF1\u65E7\uFF08\u660E\u5EA6\u5DEE=\u5E74\u9F84\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u62D6\u8282\u70B9 \xB7 \u5E73\u79FB \xB7 \u7F29\u653E \xB7 \u70B9\u8FB9\u770B\u7C7B\u578B" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DetailPanel, { selected, data: filtered })
  ] });
}
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "3", cy: "3", r: "1.8", fill: "#5b9bd5" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "11", cy: "3", r: "1.8", fill: "#e07b39" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("circle", { cx: "7", cy: "11", r: "1.8", fill: "#70ad47" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("line", { x1: "3.8", y1: "4.2", x2: "9.8", y2: "4.2", stroke: "#777", strokeWidth: "0.8" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("line", { x1: "3.6", y1: "4.6", x2: "6.4", y2: "9.6", stroke: "#777", strokeWidth: "0.8" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("line", { x1: "10.4", y1: "4.6", x2: "7.6", y2: "9.6", stroke: "#777", strokeWidth: "0.8" })
          ] }),
          wide ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "\u8BB0\u5FC6\u56FE\u8C31" }) : null
        ]
      }
    ),
    open ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: {
      position: "fixed",
      inset: 0,
      zIndex: 9999,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { display: "flex", alignItems: "center", padding: "44px 16px 10px", flex: "none" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { fontSize: 15, fontWeight: 600, color: "#ddd", letterSpacing: 0.5 }, children: "\u8BB0\u5FC6\u56FE\u8C31" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { flex: 1, minHeight: 0, position: "relative" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(MemoryGraphView, { scope }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
          {
            type: "button",
...
function MemoryLogPanel() {
  ...
  const [level, setLevel] = (0, import_react3.useState)("all");
  const [event, setEvent] = (0, import_react3.useState)("all");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { height: "100%", display: "flex", flexDirection: "column", padding: "0 16px 16px", boxSizing: "border-box" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 0", flex: "none", flexWrap: "wrap" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { fontSize: 12, color: "#aaa" }, children: [
        "\u65E5\u5FD7 ",
        logs.length,
        " \u6761 \xB7 3s \u81EA\u52A8\u5237\u65B0"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "all", children: "\u5168\u90E8\u7EA7\u522B" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "info", children: "info" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "warn", children: "warn" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "error", children: "error" })
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        "select",
        {
          ...
          children: [
            ...
            allEvents.map((e) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: e, children: e }, e))
          ]
        }
      ),
    ...
    error ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { style: { fontSize: 12, color: "#e07b39" }, children: [
      "\u52A0\u8F7D\u5931\u8D25\uFF1A",
      error
    ] }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { ref: listRef, style: { flex: 1, minHeight: 0, overflowY: "auto", fontFamily: "monospace", fontSize: 11.5, lineHeight: 1.7 }, children: logs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: { color: "#777", padding: "20px 0", fontFamily: "inherit" }, children: "\u6682\u65E0\u65E5\u5FD7\uFF08\u63D2\u4EF6\u8FD0\u884C\u540E\u81EA\u52A8\u8BB0\u5F55\u5199\u5165/\u6CE8\u5165/\u68C0\u7D22/\u5DE1\u68C0/\u84B8\u998F\uFF09" }) : logs.map((l) => {
      let detail = l.detail;
      try {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", gap: 8, borderBottom: "1px solid #232323", padding: "3px 0" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: "#666", flex: "none" }, children: t }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: levelColor[l.level] ?? "#aaa", flex: "none", width: 42 }, children: l.level.toUpperCase() }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: "#8ab4d8", flex: "none" }, children: l.event }),
        l.scope ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { color: "#6a9955", flex: "none" }, children: [
          "(",
          l.scope,
          ")"
        ] }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: "#ccc", wordBreak: "break-all" }, children: detail })
      ] }, l.id);
    }) })
  ] });
}
function MemoryLogLauncher({ wide }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M2 2h10v2H2zM2 6h10v2H2zM2 10h7v2H2z", fill: "#e07b39" }) }),
          wide ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "\u8BB0\u5FC6\u65E5\u5FD7" }) : null
        ]
      }
    ),
    open ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", padding: "44px 16px 10px", flex: "none", justifyContent: "space-between" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: 15, fontWeight: 600, color: "#ddd", letterSpacing: 0.5 }, children: "\u8BB0\u5FC6\u65E5\u5FD7" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { flex: 1, minHeight: 0, position: "relative" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MemoryLogPanel, {}),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
            type: "button",

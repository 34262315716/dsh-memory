...
var NUMERIC_SUB = /* @__PURE__ */ new Set(["cacheSize", "topK", "minCandidates", "rrfWeight", "spring", "repulsion", "damping", "gravity"]);
    ...
    try {
      ...
      if (rkKeys.some((f) => drafts[`reranker.${f}`] !== void 0)) {
        ...
        for (const [f] of RERANKER_FIELDS) {
          ...
          if (v !== void 0) next[f] = f === "enabled" ? v : NUMERIC_SUB.has(f) ? Number(v) : String(v);
        }
...
function MemoryGraphView({ scope }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", height: "100%", minHeight: 560, gap: 0 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, minWidth: 0, position: "relative", minHeight: 560 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "absolute", top: 10, left: 14, fontSize: 12, color: "#aaa", zIndex: 2 }, children: [
        "\u8BB0\u5FC6 ",
        data.stats.memories,
        " \xB7 \u4E3B\u9898 ",
        data.themes.length,
        " \xB7 \u5173\u7CFB ",
        data.edges.length,
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: load, style: { marginLeft: 10, padding: "1px 10px", borderRadius: 5, border: "1px solid #555", background: "transparent", color: "#aaa", cursor: "pointer", fontSize: 12 }, children: "\u5237\u65B0" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ObsidianGraph, { data, onSelect: setSelected, selectedRef, drawRef, physics }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "absolute", left: 14, bottom: 10, fontSize: 11, color: "#777" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { marginLeft: 10 }, children: "\u62D6\u8282\u70B9 \xB7 \u62D6\u7A7A\u767D\u5E73\u79FB \xB7 \u6EDA\u8F6E\u7F29\u653E \xB7 \u70B9\u51FB\u770B\u8BE6\u60C5" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DetailPanel, { selected, data })
  ] });
}
function MemoryGraphLauncher({ wide, scope }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    open ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "fixed", inset: 0, zIndex: 1200, background: "#121212", display: "flex", flexDirection: "column" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 16px", borderBottom: "1px solid #2a2a2a", flex: "none" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 14, fontWeight: 600, color: "#ddd" }, children: "\u8BB0\u5FC6\u56FE\u8C31" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1, minHeight: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MemoryGraphView, { scope }) })
    ] }) : null
  ] });
}
function apply(ctx) {

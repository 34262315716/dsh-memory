...
function MemorySettingsSectionInner({ scope, api, llmScope, deepseekScope }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 16, maxWidth: 680, boxSizing: "border-box" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u4E3B\u9898\u5708\u5F62\u72B6", hint: "hull=\u8D34\u5408\u51F8\u5305\uFF08\u63A8\u8350\uFF1A\u521A\u597D\u5708\u4F4F\u540C\u4E3B\u9898\u6210\u5458\uFF0C\u968F\u7EC4\u7684\u5F62\u72B6\u4E0E\u4E2D\u5FC3\u9010\u5E27\u79FB\u52A8\uFF09| circle=\u6700\u5C0F\u5916\u63A5\u5706\uFF08\u6B63\u5706\u76D8\uFF0C\u540C\u70B9\u96C6\u6700\u7D27\u7684\u5706\uFF09", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "select",
        {
          style: inputStyle,
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "hull", children: "\u8D34\u5408\u51F8\u5305\uFF08\u521A\u597D\u5708\u4F4F\uFF09" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "circle", children: "\u6700\u5C0F\u5916\u63A5\u5706\uFF08\u6B63\u5706\u76D8\uFF09" })
          ]
        }
      ) }),
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const draw = () => {
      ...
      for (const r of showcase) {
        ...
        ctx.fillStyle = `hsla(${hue},70%,58%,${r.primary ? 0.14 : 0.1})`;
        ctx.fill();
...
function MemoryGraphView({ scope }) {
  ...
  const physics = (0, import_react2.useMemo)(() => ({
    ...
    themeShape: gv.themeShape === "circle" ? "circle" : "hull",
    // 主题区域形状（v0.10.5）

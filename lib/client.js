...
var MODEL_SUGGESTIONS = ["deepseek-v4-flash", "deepseek-v4-pro", "mimo-v2.5"];
var PROVIDER_SUGGESTIONS = ["opencode-go", "deepseek-official", "memory-refiner", "deepseek"];
...
function MemorySettingsCard(props) {
  ...
  const keyRef = () => {
    ...
    return (d !== void 0 && d !== "" ? d : refiner.apiKeyEnv) || "MEMORY_REFINER_API_KEY";
  };
  ...
  (0, import_react.useEffect)(() => {
    void checkKey();
  }, [drafts["refiner.apiKeyEnv"], refiner.apiKeyEnv]);
  const saveKey = async () => {
    if (!keyDraft) return;
    const ref = keyRef();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "12px 0" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Field, { label: "\u4F9B\u5E94\u5546 Provider", hint: "opencode-go / deepseek-official / \u81EA\u5EFA\u72EC\u7ACB\u4F9B\u5E94\u5546", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("datalist", { id: "dsh-memory-providers", children: PROVIDER_SUGGESTIONS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: p }, p)) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Field, { label: "\u6A21\u578B", hint: "deepseek-v4-flash / deepseek-v4-pro / mimo-v2.5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("datalist", { id: "dsh-memory-models", children: MODEL_SUGGESTIONS.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: m }, m)) })
    ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 8, padding: 10, border: "1px solid #3a3a3a", borderRadius: 8, background: "#1a1a1a" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 13 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontWeight: 500 }, children: "\u72EC\u7ACB API \u5BC6\u94A5" }),

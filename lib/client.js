...
var STOP_SPEED = 0.02;
var AUTO_DOWNGRADE = { balanced: 900, instant: 1800 };
...
var DetailPanel = (0, import_react2.memo)(function DetailPanel2({ selected, data }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { width: 280, borderLeft: "1px solid #333", padding: 14, overflowY: "auto", background: "#161616" }, children: [
    ...
    (adj.get(selected.id) ?? []).length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: { fontSize: 12, color: "#777" }, children: "\u6682\u65E0\u5173\u8054" }) : (adj.get(selected.id) ?? []).map((a, i) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontSize: 12, margin: "4px 0", color: "#bbb" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { color: a.type === "similarTo" ? "#5b9bd5" : "#e07b39" }, children: [
          "[",
          a.type,
          "]"
        ] }),

...
var ObsidianGraph = (0, import_react.memo)(function ObsidianGraph2({ data, onSelect, selectedRef, drawRef, physics, focusIdsRef }) {
...
function MemoryGraphView({ scope }) {
  ...
  const focusIdsRef = (0, import_react.useRef)(null);
  (0, import_react.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", height: "100%", minHeight: 560, gap: 0 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, minWidth: 0, position: "relative", minHeight: 560 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "absolute", top: 10, left: 14, fontSize: 12, color: "#aaa", zIndex: 2, display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "all", children: "\u5168\u90E8\u4E8B\u4EF6" }),
              (data?.events ?? []).map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", { value: e.id, children: [
                e.label,
                "\uFF08",
                e.count,
                " \u6761\uFF09"
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ObsidianGraph, { data: filtered, onSelect: setSelected, selectedRef, drawRef, physics, focusIdsRef }),
...
function MemoryLogPanel() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { height: "100%", display: "flex", flexDirection: "column", padding: "0 16px 16px", boxSizing: "border-box" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 0", flex: "none", flexWrap: "wrap" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "all", children: "\u5168\u90E8\u7EA7\u522B" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "info", children: "info" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "warn", children: "warn" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "all", children: "\u5168\u90E8\u4E8B\u4EF6" }),
            allEvents.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: e, children: e }, e))
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    ...
    error ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { fontSize: 12, color: "#e07b39" }, children: [
      "\u52A0\u8F7D\u5931\u8D25\uFF1A",
      error
    ] }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref: listRef, style: { flex: 1, minHeight: 0, overflowY: "auto", fontFamily: "monospace", fontSize: 11.5, lineHeight: 1.7 }, children: logs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: "#777", padding: "20px 0", fontFamily: "inherit" }, children: "\u6682\u65E0\u65E5\u5FD7\uFF08\u63D2\u4EF6\u8FD0\u884C\u540E\u81EA\u52A8\u8BB0\u5F55\u5199\u5165/\u6CE8\u5165/\u68C0\u7D22/\u5DE1\u68C0/\u84B8\u998F\uFF09" }) : logs.map((l) => {
      let detail = l.detail;
      try {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 8, borderBottom: "1px solid #232323", padding: "3px 0" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#666", flex: "none" }, children: t }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: levelColor[l.level] ?? "#aaa", flex: "none", width: 42 }, children: l.level.toUpperCase() }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#8ab4d8", flex: "none" }, children: l.event }),
        l.scope ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: "#6a9955", flex: "none" }, children: [
          "(",
          l.scope,
          ")"
        ] }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "#ccc", wordBreak: "break-all" }, children: detail })
      ] }, l.id);
    }) })
  ] });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M2 2h10v2H2zM2 6h10v2H2zM2 10h7v2H2z", fill: "#e07b39" }) }),
          wide ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u8BB0\u5FC6\u65E5\u5FD7" }) : null
        ]
      }
    ),
    open ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", padding: "44px 16px 10px", flex: "none", justifyContent: "space-between" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 15, fontWeight: 600, color: "#ddd", letterSpacing: 0.5 }, children: "\u8BB0\u5FC6\u65E5\u5FD7" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, minHeight: 0, position: "relative" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MemoryLogPanel, {}),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            type: "button",

...
var RERANKER_FIELDS = [
  ...
  ["rrfWeight", "RRF \u6743\u91CD", "\u878D\u5408\u5206 = w\xD7RRF + (1-w)\xD7\u91CD\u6392\u5206\uFF080~1\uFF0C\u9ED8\u8BA4 0.7\uFF1B\u9700\u91CD\u542F DSH \u751F\u6548\uFF09"]
];
...
var NUMERIC_SUB = /* @__PURE__ */ new Set(["cacheSize", "topK", "minCandidates", "rrfWeight", "spring", "repulsion", "damping", "gravity", "interval", "maxIntervalHours", "dedupThreshold", "agingDays", "gapHours", "maxRows", "maxTokens", "timeBudgetMs", "maxContinuations"]);
var T = {
...
function Field({ label, hint, children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "block", margin: "10px 0" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { display: "block", fontWeight: 500, fontSize: 13, color: T.label }, children: label }),
    hint ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { display: "block", color: T.sub, fontSize: 12, lineHeight: "18px", marginTop: 2 }, children: hint }) : null,
    children
  ] });
}
var inputStyle = {
...
function CheckboxRow({ label, hint, checked, onChange }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: 8, margin: "6px 0", fontSize: 13, color: T.label, cursor: "pointer" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "checkbox", checked, onChange }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: label }),
    hint ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: T.sub, fontSize: 12 }, children: [
      "\u2014 ",
      hint
    ] }) : null
  ] });
...
function KeyInput({ api, keyRef, hint }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 10, paddingTop: 10, borderTop: `1px solid ${T.line}` }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: T.label }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontWeight: 500 }, children: "API \u5BC6\u94A5" }),
      state.checking ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: T.sub, fontSize: 12 }, children: "\u68C0\u67E5\u4E2D\u2026" }) : state.configured ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: T.ok, fontSize: 12 }, children: [
        "\u25CF \u5DF2\u914D\u7F6E\uFF08",
        keyRef,
        "\uFF09"
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: T.warnText, fontSize: 12 }, children: [
        "\u25CB \u672A\u914D\u7F6E\uFF08",
        keyRef,
        "\uFF09"
      ] })
    ] }),
    hint ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: T.sub, fontSize: 12, margin: "6px 0" }, children: hint }) : null,
...
var SettingsErrorBoundary = class extends import_react.default.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    if (this.state.error) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 16 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: T.warnText, fontWeight: 500, fontSize: 13 }, children: "\u26A0 \u8BBE\u7F6E\u9762\u677F\u6E32\u67D3\u51FA\u9519" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { style: { whiteSpace: "pre-wrap", fontSize: 12, color: T.err, background: T.fieldBg, padding: 8, borderRadius: 8, margin: "8px 0" }, children: String(this.state.error?.message ?? this.state.error) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
...
function HealthReport({ data }) {
  ...
  const rows = [
    {
      ...
      cfg: `${data.embedding.provider} \xB7 ${data.embedding.model} \u2192 ${data.embedding.endpoint}`,
      okText: `\u8FD4\u56DE ${data.embedding.live?.dim ?? "?"} \u7EF4 \xB7 ${data.embedding.live?.ms ?? "?"}ms`,
      tail: `\u5411\u91CF\u8DEF\u5B9E\u51B5\uFF1A${active.embedder ?? "?"} \xB7 ${active.dim ?? "?"} \u7EF4 \xB7 ${active.rows ?? 0} \u6761` + (active.degraded ? "\uFF08\u964D\u7EA7\u6001\uFF1A\u8FDC\u7AEF\u4E0D\u53EF\u7528\uFF0C\u54C8\u5E0C\u515C\u5E95\u4E14\u5411\u91CF\u8DEF\u6682\u505C\uFF09" : "") + (data.embedding.live?.ok && active.embedder === "rule" ? "\u2014\u2014\u8FDC\u7AEF\u73B0\u5728\u901A\u4E86\uFF0C\u91CD\u542F DSH \u540E\u624D\u4F1A\u5207\u56DE" : "")
    },
    {
      key: "reranker",
      title: "\u91CD\u6392",
      live: data.reranker.enabled ? data.reranker.live : null,
      cfg: `${data.reranker.enabled ? "\u542F\u7528" : "\u672A\u542F\u7528"} \xB7 ${data.reranker.model} \u2192 ${data.reranker.endpoint}`,
      okText: `\u6253\u5206 ${JSON.stringify(data.reranker.live?.scores ?? [])} \xB7 ${data.reranker.live?.ms ?? "?"}ms`,
    ...
    },
    {
      ...
      cfg: `${data.refiner.enabled ? "\u542F\u7528" : "\u672A\u542F\u7528"} \xB7 ${data.refiner.provider} / ${data.refiner.model}`,
      okText: `\u56DE\u5305 ${JSON.stringify(data.refiner.live?.text ?? "")} \xB7 ${data.refiner.live?.ms ?? "?"}ms`,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 12 }, children: [
    rows.map((r) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 8, paddingTop: 8, borderTop: `1px solid ${T.line}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 13, color: T.label }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: dot[st] }, children: "\u25CF" }),
          " ",
          r.title,
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: dot[st], fontSize: 12, marginLeft: 6 }, children: tag[st] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: T.sub, fontSize: 12, marginLeft: 8 }, children: r.cfg })
        ] }),
        r.live?.ok ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: T.sub, marginTop: 2 }, children: r.okText }) : null,
        r.live && !r.live.ok ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: T.err, marginTop: 2 }, children: r.live.error }) : null,
        r.tail ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, color: T.sub, marginTop: 2 }, children: r.tail }) : null
      ] }, r.key);
    }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 12, color: T.dim, marginTop: 8 }, children: [
      "\u68C0\u6D4B\u65F6\u95F4 ",
      data.checkedAt
    ] })
  ] });
...
function MemorySettingsSection(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SettingsErrorBoundary, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MemorySettingsSectionInner, { ...props }) });
}
function MemorySettingsSectionInner({ scope, api, llmScope, deepseekScope }) {
  ...
  const [llmSnap, setLlmSnap] = (0, import_react.useState)(() => safeSnapshot(llmScope));
  (0, import_react.useEffect)(() => llmScope.subscribe(() => setLlmSnap(safeSnapshot(llmScope))), [llmScope]);
  const [deepseekSnap, setDeepseekSnap] = (0, import_react.useState)(() => safeSnapshot(deepseekScope));
  (0, import_react.useEffect)(() => deepseekScope.subscribe(() => setDeepseekSnap(safeSnapshot(deepseekScope))), [deepseekScope]);
  const [drafts, setDrafts] = (0, import_react.useState)({});
  const [saving, setSaving] = (0, import_react.useState)(false);
  const [msg, setMsg] = (0, import_react.useState)("");
  const [health, setHealth] = (0, import_react.useState)({ running: false, data: null, error: "" });
  ...
  const modelGroups = (0, import_react.useMemo)(() => {
    const groups = [];
  ...
  const embChanging = drafts["embedding.provider"] !== void 0 && drafts["embedding.provider"] !== (embedding.provider ?? "remote") || drafts["embedding.model"] !== void 0 && drafts["embedding.model"] !== (embedding.model ?? "");
  const [embedAck, setEmbedAck] = (0, import_react.useState)(false);
  ...
  (0, import_react.useEffect)(() => {
    void checkKey();
  }, [drafts["refiner.apiKeyEnv"], refiner.apiKeyEnv, providerValue, llmSnap, deepseekSnap]);
  const saveKey = async () => {
    if (!keyDraft) return;
    const ref = keyRef();
  ...
  const TEXT_TOP = /* @__PURE__ */ new Set(["dbFile", "scope", "injectPace"]);
  ...
  const save = async () => {
    ...
    try {
      ...
      if (drafts["enabled"] !== void 0) await scope.set("enabled", drafts["enabled"]);
      if (drafts["dbFile"] !== void 0) {
        if (drafts["dbFile"] === "") await scope.unset("dbFile");
        else await scope.set("dbFile", drafts["dbFile"]);
      }
      if (drafts["scope"] !== void 0) {
        if (drafts["scope"] === "") await scope.unset("scope");
        else await scope.set("scope", drafts["scope"]);
      }
      if (drafts["injectPace"] !== void 0) await scope.set("injectPace", drafts["injectPace"]);
      ...
      if (rkKeys.some((f) => drafts[`reranker.${f}`] !== void 0) || drafts["reranker.enabled"] !== void 0) {
        const next = { ...reranker };
        for (const [f] of RERANKER_FIELDS) {
          const v = drafts[`reranker.${f}`];
          if (v !== void 0) next[f] = NUMERIC_SUB.has(f) ? Number(v) : String(v);
        }
        if (drafts["reranker.enabled"] !== void 0) next.enabled = drafts["reranker.enabled"];
        await scope.set("reranker", next);
      }
      {
      }
      const gvKeys = GRAPH_VIEW_FIELDS.map(([f]) => f);
      if (gvKeys.some((f) => drafts[`graphView.${f}`] !== void 0) || drafts["graphView.themeShape"] !== void 0 || drafts["graphView.themeScope"] !== void 0) {
        const next = { ...graphView };
        for (const [f] of GRAPH_VIEW_FIELDS) {
          const v = drafts[`graphView.${f}`];
          if (v !== void 0) next[f] = Number(v);
        }
        if (drafts["graphView.themeShape"] !== void 0) next.themeShape = String(drafts["graphView.themeShape"]);
        if (drafts["graphView.themeScope"] !== void 0) next.themeScope = String(drafts["graphView.themeScope"]);
      ...
      if (hkKeys.some((f) => drafts[`housekeeping.${f}`] !== void 0) || drafts["housekeeping.enabled"] !== void 0) {
        ...
        if (drafts["housekeeping.autoApply"] !== void 0) next.autoApply = drafts["housekeeping.autoApply"];
        await scope.set("housekeeping", next);
      }
      {
      }
      if (drafts["sessionSummary.enabled"] !== void 0 || drafts["sessionSummary.rounds"] !== void 0) {
        const next = { ...sessionSummary ?? {} };
        if (drafts["sessionSummary.enabled"] !== void 0) next.enabled = drafts["sessionSummary.enabled"];
        if (drafts["sessionSummary.rounds"] !== void 0) next.rounds = Number(drafts["sessionSummary.rounds"]);
        await scope.set("sessionSummary", next);
      }
      {
      }
      const evKeys = EVENTS_FIELDS.map(([f]) => f);
      if (evKeys.some((f) => drafts[`events.${f}`] !== void 0) || drafts["events.enabled"] !== void 0) {
        const next = { ...events };
        for (const [f] of EVENTS_FIELDS) {
          const v = drafts[`events.${f}`];
          if (v !== void 0) next[f] = Number(v);
        }
        if (drafts["events.enabled"] !== void 0) next.enabled = drafts["events.enabled"];
        await scope.set("events", next);
      }
      {
      }
      const lgKeys = LOGGING_FIELDS.map(([f]) => f);
      if (lgKeys.some((f) => drafts[`logging.${f}`] !== void 0) || drafts["logging.enabled"] !== void 0) {
        const next = { ...logging };
        for (const [f] of LOGGING_FIELDS) {
          const v = drafts[`logging.${f}`];
          if (v !== void 0) next[f] = Number(v);
        }
        if (drafts["logging.enabled"] !== void 0) next.enabled = drafts["logging.enabled"];
  ...
  if (status !== "ready") {
    ...
    const loading = bound && (status === "loading" || status === "idle" || status === void 0);
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 16, maxWidth: 680, boxSizing: "border-box" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { style: { margin: "0 0 8px", fontSize: 16, color: T.label }, children: "\u8BB0\u5FC6" }),
      loading && bound ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: T.sub, fontSize: 13 }, children: "\u8BB0\u5FC6\u63D2\u4EF6\u8BBE\u7F6E\u52A0\u8F7D\u4E2D\u2026" }) : !bound ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { color: T.sub, fontSize: 13, lineHeight: 1.7 }, children: [
        "\u8BB0\u5FC6\u63D2\u4EF6\u8BBE\u7F6E\u4E0D\u53EF\u7528\uFF1A\u5BA2\u6237\u7AEF\u6CA1\u53D6\u5230\u8BBE\u7F6E\u670D\u52A1\uFF08settingsScope\uFF09\u3002",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
        "\u8FD9\u901A\u5E38\u662F\u4E0A\u6E38 ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "dsh-client-ui-settings" }),
        " \u672A\u52A0\u8F7D\u6216\u672A\u542F\u52A8\u5B8C\u6210\uFF1B",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "\u5237\u65B0\u9875\u9762\uFF08F5 / Ctrl+R\uFF09" }),
        "\u540E\u518D\u6253\u5F00\u672C\u9875\uFF0C\u591A\u534A\u5373\u53EF\u6062\u590D\u3002"
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { color: T.sub, fontSize: 13, lineHeight: 1.7 }, children: [
        "\u8BB0\u5FC6\u63D2\u4EF6\u8BBE\u7F6E\u4E0D\u53EF\u7528\uFF1A\u5BBF\u4E3B\u6CA1\u6709\u5BF9\u5916\u63D0\u4F9B ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "memory" }),
        " \u547D\u540D\u7A7A\u95F4\u3002",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
        "\u8BF7\u6253\u5F00 ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "settings.yaml" }),
        " \u68C0\u67E5 ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "memory" }),
        " \u6BB5\u2014\u2014\u67D0\u4E2A\u53D6\u503C\u8D8A\u754C\u4F1A\u8BA9 \u5BBF\u4E3B\u6CE8\u518C\u5931\u8D25\uFF08\u65E5\u5FD7\u91CC\u4F1A\u6709 ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "[dsh-memory] settings \u6CE8\u518C\u5931\u8D25" }),
        "\uFF09\u3002"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { color: T.sub, fontSize: 11, marginTop: 10, opacity: 0.7 }, children: [
        "\u8BCA\u65AD\uFF1Astatus=",
        String(status),
        "\u30FBscope=",
        bound ? "\u5DF2\u8FDE\u63A5" : "\u672A\u8FDE\u63A5",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: 16, maxWidth: 680, boxSizing: "border-box" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { style: { margin: "0 0 4px", fontSize: 16, color: T.label }, children: "\u8BB0\u5FC6" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 12px", color: T.sub, fontSize: 13 }, children: "dsh-memory \u81EA\u52A8\u8BB0\u5FC6\u63D2\u4EF6\u2014\u2014\u591A\u6570\u6539\u52A8\u5373\u65F6\u751F\u6548\uFF08live\uFF09\uFF0C\u5199\u5165 settings.yaml \u7684 memory \u6BB5\uFF1B \u6807\u6CE8\u300C\u9700\u91CD\u542F\u300D\u7684\u5B57\u6BB5\u8981\u91CD\u542F DSH \u624D\u751F\u6548\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => void runHealth(), disabled: health.running, style: ghostBtn, children: health.running ? "\u68C0\u6D4B\u4E2D\u2026" : "\u8FDE\u901A\u6027\u81EA\u68C0" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: T.sub, fontSize: 12 }, children: "\u5BF9\u5D4C\u5165 / \u91CD\u6392 / \u63D0\u53D6\u5404\u53D1\u4E00\u6B21\u771F\u5B9E\u6700\u5C0F\u8BF7\u6C42\uFF08\u63D0\u53D6\u63A2\u9488\u4F1A\u4EA7\u751F\u4E00\u6B21\u6781\u5C0F\u7684 LLM \u8C03\u7528\uFF09" })
    ] }),
    health.error ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { color: T.err, fontSize: 12, margin: "8px 0 0" }, children: [
      "\u81EA\u68C0\u8BF7\u6C42\u5931\u8D25\uFF1A",
      health.error
    ] }) : null,
    health.data ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HealthReport, { data: health.data }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: blockTitle, children: "\u57FA\u7840\u914D\u7F6E" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        CheckboxRow,
        {
          label: "\u542F\u7528\u63D2\u4EF6",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u6570\u636E\u5E93\u6587\u4EF6\uFF08dbFile\uFF09", hint: "\u7559\u7A7A\u9ED8\u8BA4 ~/.dsh/memory.db\uFF1B\u6539\u52A8\u9700\u91CD\u542F\u751F\u6548", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u9ED8\u8BA4\u4F5C\u7528\u57DF\uFF08scope\uFF09", hint: "\u8DE8\u4F1A\u8BDD\u9ED8\u8BA4\u6536\u7A84\u5230\u5F53\u524D\u5DE5\u4F5C\u76EE\u5F55\u540D\uFF1B\u7559\u7A7A\u81EA\u52A8\u6309\u5DE5\u4F5C\u533A\uFF08v0.9.4 \u5206\u5C42\uFF09", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: T.sub, fontSize: 12, margin: "0 0 10px 0" }, children: "v0.10 \u6CE8\u5165\u52A0\u6743\uFF1A\u753B\u50CF \xD73 \xB7 principle\uFF08\u65B9\u6CD5/\u539F\u5219\uFF09\xD71.5 \u4F18\u5148 \xB7 event\uFF08\u4E8B\u4EF6/\u4EA7\u51FA\uFF09\xD70.7 \u964D\u6743\uFF08\u5F3A\u76F8\u5173\u624D\u6CE8\u5165\uFF09\uFF1B \u84B8\u998F\u8F93\u51FA\u81EA\u52A8\u6253 theme \u540D\u8BCD\u6807\u7B7E\uFF08\u4EC5\u65B0\u8BB0\u5FC6\uFF09\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        Field,
        {
          label: "\u6CE8\u5165\u8282\u594F",
          hint: paceSteps ? `\u5F53\u524D\u751F\u6548\uFF1A\u6BCF ${paceSteps} \u6B65\u91CD\u65B0\u68C0\u7D22\u4E00\u6B21\u5E76\u628A\u76F8\u5173\u8BB0\u5FC6\u6CE8\u5165\uFF08\u6B65\u8DDD\u5230\u5FC5\u68C0\uFF1B\u5185\u5BB9\u6CA1\u53D8\u5219\u4E0D\u91CD\u590D\u6CE8\u5165\uFF09` : "\u81EA\u5B9A\u4E49\u6863\uFF1A\u6309\u4E0B\u9762\u7684\u300C\u6B65\u8DDD\u8282\u6D41\u300D\u6570\u5B57\u6267\u884C\uFF0C\u53D6\u503C 1~60",
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "select",
            {
              ...
              children: INJECT_PACE_OPTIONS.map(([key, label, steps, desc]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", { value: key, children: [
                steps ? `${label}\uFF08\u6BCF ${steps} \u6B65\uFF09` : label,
                " \u2014 ",
                desc
              ] }, key))
            }
      ...
      NUMBER_FIELDS.map(([field, label, hint]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        Field,
        {
          label,
          hint: field === "stepInterval" && paceSteps ? `\u5F53\u524D\u300C\u6CE8\u5165\u8282\u594F\u300D\u9009\u7684\u662F${paceLabel}\u6863\uFF08\u6BCF ${paceSteps} \u6B65\uFF09\uFF0C\u6B64\u6570\u5B57\u6682\u4E0D\u751F\u6548\u2014\u2014\u5207\u5230\u300C\u81EA\u5B9A\u4E49\u300D\u6863\u624D\u7528\u5B83` : hint,
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "input",
            {
              style: inputStyle,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u63A8\u7406\u6863\u4F4D\uFF08reasoningEffort\uFF09", hint: "low/medium/high = \u660E\u786E\u601D\u8003\u6863\uFF08\u9ED8\u8BA4 low\uFF1A\u5148\u5224\u65AD\u518D\u5199\uFF09\u3002\u6CE8\u610F off \u4E0D\u7B49\u4E8E\u5173\u601D\u8003\u2014\u2014\u9002\u914D\u5668\u628A off \u5F53\u300C\u4E0D\u4F20\u53C2\u6570\u300D\uFF0C\u601D\u8003\u578B\u6A21\u578B\uFF08\u5982 deepseek-v4.1-flash\uFF09\u7167\u6837\u601D\u8003\uFF1B\u4EC5\u9002\u914D\u5668\u58F0\u660E supportsReasoningEffort \u65F6\u900F\u4F20", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u8F93\u51FA\u4E0A\u9650\uFF08maxTokens\uFF09", hint: "0 = \u4E0D\u9650\u5236\uFF08\u9ED8\u8BA4\uFF09\u3002\u4E0D\u8BBE\u4E0A\u9650\u65F6\u601D\u8003\u60F3\u591A\u4E45\u90FD\u884C\uFF0C\u7EA6\u675F\u53EA\u5269\u65F6\u95F4\u9884\u7B97\uFF1B\u586B\u6B63\u6570\u624D\u4F1A\u900F\u4F20\u7ED9\u6A21\u578B", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u5355\u6B21\u65F6\u95F4\u9884\u7B97\uFF08timeBudgetMs\uFF09", hint: "\u6BEB\u79D2\uFF0C\u9ED8\u8BA4 120000\uFF082 \u5206\u949F\uFF09\u3002\u5230\u70B9\u4E3B\u52A8\u6390\u65AD\uFF0C\u628A\u5DF2\u7ECF\u5199\u51FA\u6765\u7684\u5185\u5BB9\u539F\u6837\u5E26\u56DE\u53BB\u7EED\u8DD1\uFF08\u65AD\u70B9\u7EED\u601D\uFF09\u2014\u2014\u300C\u9884\u7B97\u4E0D\u591F\u300D\u4E0D\u4F1A\u518D\u5BFC\u81F4\u6574\u6761\u8BB0\u5FC6\u4E22\u5931\uFF1B0 = \u4E0D\u9650\u65F6", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
          value: drafts["refiner.timeBudgetMs"] ?? String(refiner.timeBudgetMs ?? 12e4),
          disabled: !writable,
          onChange: (e) => setText("refiner", "timeBudgetMs", e.target.value)
        }
      ) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u7EED\u8DD1\u8F6E\u6570\u4E0A\u9650\uFF08maxContinuations\uFF09", hint: "\u88AB\u6390\u65AD/\u622A\u65AD/\u7A7A\u8F93\u51FA\u540E\u6700\u591A\u518D\u63A5\u7740\u5199\u51E0\u6B21\uFF08\u9ED8\u8BA4 3\uFF0C0 = \u4E0D\u7EED\u8DD1\uFF09\u3002\u7EED\u8DD1\u65F6\u4E00\u4E2A\u5B57\u90FD\u6CA1\u5199\u51FA\u6765\u4F1A\u81EA\u52A8\u505C\u6B62\uFF0C\u4E0D\u7A7A\u70E7\u914D\u989D", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 10, paddingTop: 10, borderTop: `1px solid ${T.line}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 13 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontWeight: 500 }, children: "API \u5BC6\u94A5" }),
          keyState.checking ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: T.sub, fontSize: 12 }, children: "\u68C0\u67E5\u4E2D\u2026" }) : keyState.configured ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: T.ok, fontSize: 12 }, children: [
            "\u25CF \u5DF2\u914D\u7F6E\uFF08",
            keyState.ref,
            "\uFF09"
          ] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { color: T.warnText, fontSize: 12 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { color: T.sub, fontSize: 12, margin: "6px 0" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { color: T.sub, fontSize: 12, margin: "6px 0 0" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 4px", color: T.sub, fontSize: 12 }, children: "\u5D4C\u5165\u51B3\u5B9A\u5411\u91CF\u8DEF\u8D28\u91CF\uFF08remote \u5931\u8D25\u81EA\u52A8\u964D\u7EA7 rule \u54C8\u5E0C\uFF0C\u6C38\u4E45\u515C\u5E95\uFF09\uFF1B\u91CD\u6392\u5BF9 RRF \u5019\u9009\u7CBE\u6392\uFF08\u5931\u8D25\u964D\u7EA7 RRF \u987A\u5E8F\uFF0C\u96F6\u635F\u5931\uFF09\u3002\u672C\u533A\u5168\u90E8\u5B57\u6BB5\u5728\u63D2\u4EF6\u521D\u59CB\u5316\u65F6\u8BFB\u53D6\uFF1A\u6539\u52A8\u9700\u91CD\u542F DSH \u751F\u6548\u3002" }),
      ...
      embChanging && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 10, padding: 10, border: `1px solid ${T.warnLine}`, borderRadius: 8, background: T.warnBg }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 13, fontWeight: 600, color: T.warnText }, children: "\u26A0 \u5207\u6362\u5D4C\u5165\u6A21\u578B\u4F1A\u89E6\u53D1\u5411\u91CF\u5E93\u91CD\u5EFA" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { style: { color: T.warnText, fontSize: 12, margin: "6px 0" }, children: [
          "\u5D4C\u5165\u4F9B\u5E94\u5546/\u6A21\u578B\u7684\u6539\u52A8",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "\u4E0D\u4F1A\u7ACB\u5373\u751F\u6548" }),
          "\u2014\u2014DSH \u4E0B\u6B21\u542F\u52A8\u65F6\u624D\u6309\u65B0\u914D\u7F6E\u91CD\u5EFA\uFF1A \u82E5\u5411\u91CF\u7EF4\u5EA6\u53D8\u5316\uFF0C\u4F1A",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "\u6E05\u7A7A\u5411\u91CF\u8868\u5E76\u5168\u91CF\u91CD\u5D4C\u5165" }),
          "\uFF08\u671F\u95F4\u8BED\u4E49\u68C0\u7D22\u6682\u5F31\uFF0CFTS/\u5173\u952E\u8BCD\u7167\u5E38\uFF09\uFF1B \u82E5\u8FDC\u7A0B\u5D4C\u5165\u521D\u59CB\u5316\u5931\u8D25\uFF0C\u4F1A\u8FDB\u5165",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "\u964D\u7EA7\u6001\u6682\u505C\u5411\u91CF\u8DEF" }),
          "\uFF08v0.9.31 \u4FDD\u62A4\uFF0C\u4E0D\u7834\u574F\u73B0\u6709\u5411\u91CF\uFF09\u3002"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          CheckboxRow,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 4px", color: T.sub, fontSize: 12 }, children: "\u6253\u5F00\u300C\u8BB0\u5FC6\u56FE\u8C31\u300D\u9762\u677F\u65F6\u8BFB\u53D6\uFF1B\u6539\u52A8\u540E\u91CD\u5F00\u9762\u677F\u751F\u6548\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u4E3B\u9898\u5708\u663E\u793A", hint: "\u805A\u7126\u65F6=\u53EA\u5728\u60AC\u505C/\u9009\u4E2D\u8282\u70B9\u65F6\u663E\u793A\u5B83\u6240\u5C5E\u4E3B\u9898\u7684\u5B8C\u6574\u8303\u56F4\uFF08\u9ED8\u8BA4\uFF0C\u96F6\u5E72\u6270\uFF09| \u5E38\u663E=\u4E3A\u6BCF\u4E2A\u4E3B\u9898\u7684\u5BC6\u96C6\u56E2\u753B\u5708\uFF08\u6EE4\u6389\u7A00\u758F\u672B\u7AEF\uFF0C\u6700\u591A 8 \u7247\uFF09| \u5173\u95ED=\u4E0D\u753B", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "select",
        {
          style: inputStyle,
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "focus", children: "\u805A\u7126\u65F6\u663E\u793A\uFF08\u63A8\u8350\uFF09" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "always", children: "\u5E38\u663E\uFF08\u5BC6\u96C6\u56E2\uFF09" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "off", children: "\u5173\u95ED" })
          ]
        }
      ) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u4E3B\u9898\u5708\u5F62\u72B6", hint: "\u5706\u5F62=\u6700\u5C0F\u5916\u63A5\u5706\uFF08\u63A8\u8350\uFF1A\u8F6E\u5ED3\u8FDE\u7EED\u5E73\u6ED1\uFF0C\u4E0D\u4F1A\u968F\u8282\u70B9\u5FAE\u52A8\u6296\u52A8\uFF09| \u51F8\u5305=\u66F4\u8D34\u5408\u7EC4\u5F62\uFF08\u9876\u70B9\u5DF2\u9489\u4F4F\uFF0C\u6BD4\u88F8\u51F8\u5305\u7A33\u5B9A\u5F97\u591A\uFF09", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "select",
        {
          style: inputStyle,
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "circle", children: "\u5706\u5F62\uFF08\u63A8\u8350\uFF0C\u8F6E\u5ED3\u7A33\u5B9A\uFF09" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "hull", children: "\u8D34\u5408\u51F8\u5305\uFF08\u66F4\u7D27\uFF0C\u7565\u6B20\u5E73\u6ED1\uFF09" })
          ]
        }
      ) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 4px", color: T.sub, fontSize: 12 }, children: "v0.12.1 \u8D77\u662F\u771F\u6CBB\u7406\uFF1A\u8FD1\u4E4E\u91CD\u590D\u62E9\u4F18\u4FDD\u7559\u4E00\u6761\u3001\u5176\u4F59\u5F52\u6863\uFF0C\u9648\u65E7\u60C5\u666F\u5FEB\u7167\u5F52\u6863\uFF08\u53EA\u5F52\u6863\u4E0D\u5220\u9664\uFF0C\u53EF\u7528 memory_archive \u6062\u590D\uFF09\u3002 \u89E6\u53D1\u4E0E\u5BF9\u8BDD\u8F6E\u6570\u89E3\u8026\uFF1A\u6BCF\u6C89\u6DC0 N \u6761\u8BB0\u5FC6 \u6216 \u8DDD\u4E0A\u6B21\u5DE1\u68C0\u8D85 N \u5C0F\u65F6\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        CheckboxRow,
        {
          label: "\u542F\u7528\u81EA\u52A8\u5DE1\u68C0",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: blockTitle, children: "\u4F1A\u8BDD\u7EA7\u6C47\u603B\uFF08v0.12.2\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 4px", color: T.sub, fontSize: 12 }, children: '\u9010\u8F6E\u63D0\u53D6\u8BB0\u7684\u662F"\u8FD9\u4E00\u8F6E\u53D1\u751F\u4E86\u4EC0\u4E48"\uFF1B\u8FD9\u4E00\u5C42\u6512\u591F\u8F6E\u6B21\u540E\u603B\u7ED3\u4E00\u6B21"\u6574\u6BB5\u4F1A\u8BDD\u6700\u540E\u843D\u5728\u54EA\u91CC"\u2014\u2014\u4E00\u665A\u4E0A\u7684\u8BA8\u8BBA\u5B9A\u4E86\u4EC0\u4E48\u3001\u6539\u6210\u4E86\u4EC0\u4E48\u3001\u5426\u6389\u4E86\u4EC0\u4E48\u3002' }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        CheckboxRow,
        {
          label: "\u542F\u7528\u4F1A\u8BDD\u6C47\u603B",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label: "\u6C47\u603B\u8F6E\u6570\uFF08rounds\uFF09", hint: "\u7D2F\u79EF\u591A\u5C11\u8F6E\u5BF9\u8BDD\u540E\u505A\u4E00\u6B21\u6C47\u603B\uFF085~100\uFF0C\u9ED8\u8BA4 12\uFF09", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: blockTitle, children: "\u4E8B\u4EF6\u5206\u7C7B\uFF08v0.9.0\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 4px", color: T.sub, fontSize: 12 }, children: '\u65F6\u95F4\u8FDE\u7EED + \u56E0\u679C\u76F8\u5173\u7684\u8BB0\u5FC6\u805A\u7C07\u2014\u2014"\u8FD9\u6BB5\u8BB0\u5FC6\u5C5E\u4E8E\u54EA\u4EF6\u4E8B"\uFF08\u533A\u522B\u4E8E theme \u7684"\u5728\u8BB2\u4EC0\u4E48"\uFF09\uFF1B\u7EAF rule \u65F6\u95F4\u7EBF\u626B\u63CF\uFF0C\u7BA1\u5BB6/\u542F\u52A8\u81EA\u52A8\u7EF4\u62A4\u3002' }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        CheckboxRow,
        {
          label: "\u542F\u7528\u4E8B\u4EF6\u5206\u7C7B",
      ...
      EVENTS_FIELDS.map(([field, label, hint]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label, hint, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: blockStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: blockTitle, children: "\u8FD0\u884C\u65E5\u5FD7\uFF08v0.9.5\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { margin: "0 0 4px", color: T.sub, fontSize: 12 }, children: "\u80CC\u540E\u8FD0\u884C\u4E86\u4EC0\u4E48\u5B8C\u5168\u900F\u660E\u53EF\u89C1\uFF1A\u5199\u5165/\u6CE8\u5165/\u68C0\u7D22/\u5DE1\u68C0/\u84B8\u998F/\u9519\u8BEF\u5168\u94FE\u8DEF\u57CB\u70B9\uFF1BGUI\u300C\u8BB0\u5FC6\u65E5\u5FD7\u300D\u9762\u677F + memory_logs \u5DE5\u5177\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        CheckboxRow,
        {
          label: "\u542F\u7528\u8FD0\u884C\u65E5\u5FD7",
      ...
      LOGGING_FIELDS.map(([field, label, hint]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, { label, hint, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          style: inputStyle,
          type: "text",
          value: drafts[`logging.${field}`] ?? String(logging[field] ?? 2e3),
          disabled: !writable,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 16, display: "flex", gap: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ...
        {
          onClick: save,
          disabled: !dirty || invalid || saving || !writable || embChanging && !embedAck,
    ...
    invalid ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: T.warnText, fontSize: 12, margin: "6px 0 0" }, children: "\u26A0 \u6570\u503C\u5B57\u6BB5\u5FC5\u987B\u586B\u6570\u5B57" }) : null,
...
function MemoryLogPanel() {
  ...
  const [level, setLevel] = (0, import_react2.useState)("all");
  const [event, setEvent] = (0, import_react2.useState)("all");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { height: "100%", display: "flex", flexDirection: "column", padding: "0 16px 16px", boxSizing: "border-box" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "10px 0", flex: "none", flexWrap: "wrap" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { fontSize: 12, color: "#aaa" }, children: [
        "\u65E5\u5FD7 ",
        logs.length,
        " \u6761 \xB7 3s \u81EA\u52A8\u5237\u65B0"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "all", children: "\u5168\u90E8\u7EA7\u522B" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "select",
        {
          ...
          style: { padding: "2px 8px", fontSize: 12, borderRadius: 5, border: "1px solid #555", background: "#1a1a1a", color: "#ccc" },
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: "all", children: "\u5168\u90E8\u4E8B\u4EF6" }),
            allEvents.map((e) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("option", { value: e, children: e }, e))
          ]
        }
      ),
    ...
    error ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { style: { fontSize: 12, color: "#e07b39" }, children: [
      "\u52A0\u8F7D\u5931\u8D25\uFF1A",
      error
    ] }) : null,
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { ref: listRef, style: { flex: 1, minHeight: 0, overflowY: "auto", fontFamily: "monospace", fontSize: 11.5, lineHeight: 1.7 }, children: logs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: { color: "#777", padding: "20px 0", fontFamily: "inherit" }, children: "\u6682\u65E0\u65E5\u5FD7\uFF08\u63D2\u4EF6\u8FD0\u884C\u540E\u81EA\u52A8\u8BB0\u5F55\u5199\u5165/\u6CE8\u5165/\u68C0\u7D22/\u5DE1\u68C0/\u84B8\u998F\uFF09" }) : logs.map((l) => {
      let detail = l.detail;
      try {
        const p = JSON.parse(l.detail);
        if (p && typeof p === "object") detail = JSON.stringify(p);
      } catch {
      }
      const t = new Date(l.ts).toLocaleTimeString("zh-CN", { hour12: false });
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", gap: 8, borderBottom: "1px solid #232323", padding: "3px 0" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: "#666", flex: "none" }, children: t }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: levelColor[l.level] ?? "#aaa", flex: "none", width: 42 }, children: l.level.toUpperCase() }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: "#8ab4d8", flex: "none" }, children: l.event }),
        l.scope ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { color: "#6a9955", flex: "none" }, children: [
          "(",
          l.scope,
          ")"
        ] }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { color: "#ccc", wordBreak: "break-all" }, children: detail })
      ] }, l.id);
    }) })
  ] });
}

// client/graph-geometry.js
...
function convexHull(points) {
  ...
  return signedArea2(hull) < 0 ? hull.reverse() : hull;
}
...
function padConvexPolygon(poly, pad) {
...
function polygonContains(poly, p, eps = 1e-6) {
  const n = poly?.length ?? 0;
  if (n === 0) return false;
...
function circleContains(c, p, eps = 1e-6) {
  if (!c) return false;
...
function clusterByDistance(points, threshold, { minSize = 1 } = {}) {
  ...
  out.sort((g1, g2) => g2.length - g1.length || Math.min(...g1.map((p) => p.y)) - Math.min(...g2.map((p) => p.y)) || Math.min(...g1.map((p) => p.x)) - Math.min(...g2.map((p) => p.x)));
  return out;
}
function densityCore(points, { eps = 1, minNeighbors = 2, minSize = 3 } = {}) {
  const pts = (points ?? []).filter((p) => Number.isFinite(p?.x) && Number.isFinite(p?.y));
...
function themeBounds(members, { shape = "hull", pad = 18 } = {}) {
...
// client/layout-cache.js
function encodeLayout(sig, nodes) {
  const pos = [];
...
function restoredRatio(map, nodes) {
...
var KEY = "dsh-memory:graph-layout:v4";
function loadLayout() {
  try {
...
var THEME_COLORS = themePalette(14);
var TYPE_COLORS = {
  note: "hsl(199, 92%, 62%)",
  // 天青蓝（记录/中性）
  decision: "hsl(36, 95%, 61%)",
  // 琥珀（决策=行动）
  preference: "hsl(291, 52%, 62%)",
  // 紫（偏好=个性）
  lesson: "hsl(1, 83%, 63%)",
  // 珊瑚红（教训=警示）
  profile: "hsl(122, 45%, 58%)"
  // 翠绿（画像=用户本人）
};
var TYPE_COLOR_FALLBACK = "hsl(200, 16%, 60%)";
var TYPE_LABEL = { note: "\u8BB0\u5F55", decision: "\u51B3\u7B56", preference: "\u504F\u597D", lesson: "\u6559\u8BAD", profile: "\u753B\u50CF" };
...
var EDGE_STYLE = {
  ...
  causes: { color: "#e84118", dash: [], w: 1, alpha: 0.55 },
  solves: { color: "#20c997", dash: [], w: 0.95, alpha: 0.55 },
  supports: { color: "#f3c623", dash: [], w: 0.9, alpha: 0.5 },
  contradicts: { color: "#e056fd", dash: [4, 3], w: 1, alpha: 0.5 }
};
var EDGE_ORDER = ["similarTo", "before", "mentions", "partOf", "causes", "solves", "supports", "contradicts"];
var EDGE_LABEL = { similarTo: "\u8BED\u4E49\u76F8\u4F3C", before: "\u65F6\u95F4\u6F14\u5316", mentions: "\u5B9E\u4F53\u5171\u73B0", partOf: "\u90E8\u5206\u5C5E\u4E8E", causes: "\u5BFC\u81F4", solves: "\u89E3\u51B3", supports: "\u652F\u6301", contradicts: "\u77DB\u76FE" };
...
var ObsidianGraph = (0, import_react3.memo)(function ObsidianGraph2({ data, onSelect, selectedRef, drawRef, physics, focusIdsRef, themeFocusRef }) {
  const canvasRef = (0, import_react3.useRef)(null);
  const hoverRef = (0, import_react3.useRef)(null);
  const hoverEdgeRef = (0, import_react3.useRef)(null);
  (0, import_react3.useEffect)(() => {
    ...
    const themeCentroid = /* @__PURE__ */ new Map();
    if (cacheMap) {
    ...
    const nodes = data.nodes.map((n) => {
      ...
      const p = cachedPos ?? (cen ? [cen[0] + (Math.random() - 0.5) * 90, cen[1] + (Math.random() - 0.5) * 90] : null) ?? init.positions.get(n.id) ?? [W() / 2 + (Math.random() - 0.5) * 60, H() / 2 + (Math.random() - 0.5) * 60];
    ...
    const computeThemeScale = (edgeList) => {
      ...
      clusterR = Math.min(280, Math.max(40, 1.6 * med));
      coreEps = Math.max(24, 1 * med);
      return { clusterR, coreEps };
    };
    const regionPlanCache = /* @__PURE__ */ new Map();
    const regionSmooth = /* @__PURE__ */ new Map();
    ...
    let dragNode = null;
    const dragScope = /* @__PURE__ */ new Set();
    ...
    const themeAnchor = /* @__PURE__ */ new Map();
    for (const n of nodes) {
    ...
    const step = (fixedAlpha) => {
      ...
      for (const n of nodes) {
        ...
        if (dragNode && !dragScope.has(n.id)) {
          n.vx = 0;
          n.vy = 0;
          continue;
        }
    ...
    const draw = () => {
      ...
      const themeGroupsAll = /* @__PURE__ */ new Map();
      for (const n of nodes) {
        const t = n.theme;
        if (!t || t === "(\u672A\u5F52\u7C7B)") continue;
      ...
      if (!plan) {
        if (regionPlanCache.size > 48) {
          regionPlanCache.clear();
          regionSmooth.clear();
        }
      ...
      for (let i = 0; i < plan.length; i++) {
        ...
        if (themeShape === "hull" && r.pinnedIds && r.pinnedIds.length >= 3) {
          ...
          raw = hull.length >= 3 ? { kind: "hull", points: padConvexPolygon(hull, pad), hull, cx: 0, cy: 0, topY: 0 } : themeBounds(r.members, { shape: "circle", pad });
        } else {
        ...
        if (drawShape.kind === "hull") {
          ...
          for (let k2 = 1; k2 < pts.length; k2++) ctx.lineTo(pts[k2].x, pts[k2].y);
          ctx.closePath();
        } else {
        ...
        ctx.fillStyle = `hsla(${hue},70%,58%,${isPrimary ? 0.14 : 0.1})`;
        ctx.fill();
        ...
        themeLabels.push({
          text: (isPrimaryLabel ? r.total : r.members.length) + " \xB7 " + r.theme,
          x: drawShape.cx,
      ...
      if (hovE) {
        ...
        const lbl = (EDGE_LABEL[hovE.type] ?? hovE.type) + (hovE.type === "similarTo" ? " " + Number(hovE.weight ?? 0).toFixed(2) : "") + (hovE.type === "mentions" ? " \xD7" + (hovE.weight ?? 1) : "");
      ...
      if (themeLabels.length > 0) {
        ...
        ctx.textAlign = "center";
        const placed = [];
        const perTheme = /* @__PURE__ */ new Map();
    ...
    const hitTest = (mx, my) => {
      ...
      let best = null, bestD = (nodeRadiusOf({ degree: 14 }) + 8) ** 2;
      for (const n of nodes) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("canvas", { ref: canvasRef, style: { width: "100%", height: "100%", display: "block", cursor: "grab" } });
});
var DetailPanel = (0, import_react3.memo)(function DetailPanel2({ selected, data }) {
  const { colorOf, adj, nodeById } = (0, import_react3.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { width: 280, borderLeft: "1px solid #333", padding: 14, overflowY: "auto", background: "#161616" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h4", { style: { margin: "0 0 8px", color: colorOf(selected.theme, selected.type) }, children: selected.theme || "(\u672A\u5F52\u7C7B)" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { style: { fontSize: 12, color: "#888", margin: "0 0 10px" }, children: [
      selected.type,
      " \xB7 ",
      selected.layer,
      " \xB7 strength ",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { style: { fontSize: 12, margin: "0 0 10px" }, children: [
      (selected.versions ?? 1) > 1 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { color: "#ffd54f" }, children: [
        "\u25C9 \u66F4\u65B0\u8FC7 ",
        (selected.versions ?? 1) - 1,
        " \u6B21\uFF08\u4E16\u754C\u7EBF\u4FDD\u7559\u6700\u8FD1 ",
        selected.versions ?? 1,
        " \u6BB5\uFF09"
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: "#777" }, children: "\u25CB \u672A\u66F4\u65B0\u8FC7\uFF08\u5355\u7248\u672C\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { color: "#888" }, children: [
        " \xB7 \u521B\u5EFA\u4E8E ",
        agoText(selected.createdAt)
      ] }),
      selected.updatedAt && selected.updatedAt !== selected.createdAt ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { color: "#888" }, children: [
        " \xB7 \u6700\u540E\u66F4\u65B0 ",
        agoText(selected.updatedAt)
      ] }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: { fontSize: 13, lineHeight: 1.6, whiteSpace: "pre-wrap" }, children: selected.content }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h5", { style: { margin: "14px 0 6px", fontSize: 12, color: "#aaa" }, children: "\u5173\u8054\u8BB0\u5FC6" }),
    (adj.get(selected.id) ?? []).length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { style: { fontSize: 12, color: "#777" }, children: "\u6682\u65E0\u5173\u8054" }) : (adj.get(selected.id) ?? []).map((a, i) => {
      const other = nodeById.get(a.other);
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { fontSize: 12, margin: "4px 0", color: "#bbb" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { color: a.type === "similarTo" ? "#5b9bd5" : "#e07b39" }, children: [
          "[",
          a.type,
          "]"
        ] }),
...
function MemoryGraphView({ scope }) {
  ...
  const drawRef = (0, import_react3.useRef)(null);
  const [gv, setGv] = (0, import_react3.useState)(() => {
    try {
  ...
  const physics = (0, import_react3.useMemo)(() => ({
    ...
    themeShape: gv.themeShape === "hull" ? "hull" : "circle",
    // 主题区域形状（v0.10.8：默认圆形，轮廓连续不抖）
    themeScope: gv.themeScope === "always" || gv.themeScope === "off" ? gv.themeScope : "focus"
    // 显示策略（v0.10.6）
  ...
  (0, import_react3.useEffect)(load, [load]);
  (0, import_react3.useEffect)(() => {
    selectedRef.current = selected?.id ?? null;
    drawRef.current?.();
  }, [selected]);
  const [ageWindow, setAgeWindow] = (0, import_react3.useState)("all");
  ...
  const [eventFilter, setEventFilter] = (0, import_react3.useState)("all");
  const focusIdsRef = (0, import_react3.useRef)(null);
  (0, import_react3.useEffect)(() => {
  ...
  const [themeFilter, setThemeFilter] = (0, import_react3.useState)("all");
  const themeFocusRef = (0, import_react3.useRef)(null);
  const themeStampRef = (0, import_react3.useRef)(0);
  const themeCounts = (0, import_react3.useMemo)(() => {
  ...
  if (error) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { padding: 24 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { style: { margin: "0 0 12px" }, children: "\u8BB0\u5FC6\u56FE\u8C31" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { style: { color: "#e07b39" }, children: [
        "\u52A0\u8F7D\u5931\u8D25\uFF1A",
        error
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { onClick: load, style: { padding: "4px 16px", borderRadius: 6, border: "1px solid #555", background: "transparent", color: "#aaa", cursor: "pointer" }, children: "\u91CD\u8BD5" })
    ] });
  }
  if (!data) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { padding: 24, color: "#888" }, children: "\u52A0\u8F7D\u8BB0\u5FC6\u56FE\u8C31\u4E2D\u2026" });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", height: "100%", minHeight: 560, gap: 0 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { flex: 1, minWidth: 0, position: "relative", minHeight: 560 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { position: "absolute", top: 10, left: 14, fontSize: 12, color: "#aaa", zIndex: 2, display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "select",
          {
            ...
            children: AGE_WINDOWS.map(([v, label]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: v, children: label }, v))
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "all", children: "\u5168\u90E8\u4E8B\u4EF6" }),
              (data?.events ?? []).map((e) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("option", { value: e.id, children: [
                e.label,
                "\uFF08",
                e.count,
                " \u6761\uFF09"
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: "all", children: "\u5168\u90E8\u4E3B\u9898" }),
              themeCounts.map(([t, c]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("option", { value: t, children: [
                t,
                "\uFF08",
                c,
                " \u6761\uFF09"
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("button", { onClick: load, style: { padding: "1px 10px", borderRadius: 5, border: "1px solid #555", background: "transparent", color: "#aaa", cursor: "pointer", fontSize: 12 }, children: "\u5237\u65B0" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ObsidianGraph, { data: filtered, onSelect: setSelected, selectedRef, drawRef, physics, focusIdsRef, themeFocusRef }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { position: "absolute", right: 14, bottom: 10, fontSize: 11, color: "#777", zIndex: 2, display: "flex", flexWrap: "wrap", gap: 8, maxWidth: "72%", justifyContent: "flex-end", alignItems: "center" }, children: [
        (filtered?.nodes ?? []).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "\u8282\u70B9\u8272\uFF1A" }),
          Object.entries(TYPE_COLORS).filter(([t2]) => (filtered?.nodes ?? []).some((n) => n.type === t2)).map(([t2, c]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: 3 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("i", { style: { width: 8, height: 8, borderRadius: "50%", background: c, display: "inline-block" } }),
            TYPE_LABEL[t2] ?? t2
          ] }, t2)),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: "#888" }, children: "\u65E0\u4E3B\u9898\u9ED8\u8BA4\u6309\u7C7B\u578B\u4E0A\u8272" })
        ] }),
        EDGE_ORDER.filter((t2) => (filtered?.edges ?? []).some((e) => e.type === t2)).map((t2) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { color: EDGE_STYLE[t2].color }, children: [
          t2 === "similarTo" ? "\u2014" : t2 === "before" ? "\u2192" : t2 === "mentions" ? "\xB7 \xB7" : "\u2014",
          " ",
          EDGE_LABEL[t2]
        ] }, t2)),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: "#ffd54f" }, children: "\u25CE +N = \u66F4\u65B0\u8FC7 N \u6B21" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "\u8272\u6D45\u65B0 \xB7 \u8272\u6DF1\u65E7\uFF08\u660E\u5EA6\u5DEE=\u5E74\u9F84\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "\u62D6\u8282\u70B9 \xB7 \u5E73\u79FB \xB7 \u7F29\u653E \xB7 \u70B9\u8FB9\u770B\u7C7B\u578B" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(DetailPanel, { selected, data: filtered })
  ] });
}
function MemoryGraphLauncher({ wide, scope }) {
  const [open, setOpen] = (0, import_react3.useState)(false);
  const [view, setView] = (0, import_react3.useState)("graph");
  (0, import_react3.useEffect)(() => {
    if (!open) return;
    const onKey = (e) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("linearGradient", { id: "dshMemGrad", x1: "2", y1: "2", x2: "22", y2: "22", gradientUnits: "userSpaceOnUse", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("stop", { offset: "0%", stopColor: "#7cc4ff" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("stop", { offset: "52%", stopColor: "#a78bfa" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("stop", { offset: "100%", stopColor: "#f0a868" })
            ] }) }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "9.2", stroke: "url(#dshMemGrad)", strokeWidth: "0.9", opacity: "0.3" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M5 6 L12 12 M19 6 L12 12 M12 12 L12 20", stroke: "url(#dshMemGrad)", strokeWidth: "1.5", strokeLinecap: "round", opacity: "0.9" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "5", cy: "6", r: "2.3", fill: "url(#dshMemGrad)" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "19", cy: "6", r: "2.3", fill: "url(#dshMemGrad)" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "20", r: "2.3", fill: "url(#dshMemGrad)" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "3.1", fill: "url(#dshMemGrad)" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "3.1", fill: "#fff", opacity: "0.35" })
          ] }),
          wide ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: "\u8BB0\u5FC6" }) : null
        ]
      }
    ),
    open ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 12, padding: "44px 16px 10px", flex: "none" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: 15, fontWeight: 600, color: "#ddd", letterSpacing: 0.5 }, children: "\u8BB0\u5FC6" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { display: "flex", gap: 4 }, children: [["graph", "\u56FE\u8C31"], ["logs", "\u65E5\u5FD7"]].map(([k, label]) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
            type: "button",
            onClick: () => setView(k),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: { flex: 1, minHeight: 0, position: "relative" }, children: [
        view === "logs" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MemoryLogPanel, {}) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MemoryGraphView, { scope }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "button",
          {
            type: "button",
...
function apply(ctx) {
  ...
  const makeStub = () => {
    const stub = new Proxy(function() {
      ...
      get(_t, key) {
        ...
        if (key === "getSnapshot") return () => ({ value: {} });
  ...
  const boundScopes = /* @__PURE__ */ new Map();
  const stubScopes = /* @__PURE__ */ new Map();
  ...
  const lazyScope = (ns) => new Proxy({}, {
    get(_t, key) {
      if (typeof key === "symbol") return void 0;
      if (key === "then") return void 0;
      if (key === "__dshBound") return !!resolveScope(ns);
  ...
  try {
    console.log("[dsh-memory-client] settingsScope\uFF1A" + (ctx.get("settingsScope") ? "\u6B64\u523B\u5DF2\u5C31\u7EEA" : "\u6B64\u523B\u672A\u5C31\u7EEA \u2192 \u8F6C\u60F0\u6027\u7B49\u5F85\uFF08\u6253\u5F00\u9762\u677F\u65F6\u518D\u89E3\u6790\uFF09"));
  } catch (err) {

...
var ObsidianGraph = (0, import_react.memo)(function ObsidianGraph2({ data, onSelect, selectedRef, drawRef }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const step = () => {
      ...
      for (const n of nodes) {
        ...
        n.vx += (W() / 2 - n.x) * 5e-3 * alpha;
        n.vy += (H() / 2 - n.y) * 5e-3 * alpha;
        n.vx *= damp;
        n.vy *= damp;
        n.x += n.vx * 1.5;
        n.y += n.vy * 1.5;
...
function MemoryGraphView() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", height: "100%", minHeight: 560, gap: 0 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, minWidth: 0, position: "relative", minHeight: 560 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ObsidianGraph, { data, onSelect: setSelected, selectedRef, drawRef }),
...
function MemoryGraphLauncher({ wide }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    open ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "fixed", inset: 0, zIndex: 1200, background: "#121212", display: "flex", flexDirection: "column" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1, minHeight: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MemoryGraphView, {}) })
    ] }) : null
  ] });
}
function apply(ctx) {
